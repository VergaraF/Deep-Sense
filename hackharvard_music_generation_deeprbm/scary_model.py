...
import midi_manipulation_scary
import numpy as np
lowest_note = midi_manipulation_scary.lowerBound #the index of the lowest note on the piano roll
highest_note = midi_manipulation_scary.upperBound #the index of the highest note on the piano roll
...
def run():
    ...
    with tf.Session() as sess:
        ...
        for i in range(sample.shape[0]):
            ...
            midi_manipulation_scary.noteStateMatrixToMidi(S, "l/generated_chord_{}".format(i))
            print('saved')
