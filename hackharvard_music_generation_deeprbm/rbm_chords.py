...
songs = get_songs('sad_midi') #These songs have already been converted from midi to msgpack
...
##                print('\n',len(song))
    ...
    for i in range(sample.shape[0]):
        ...
        midi_manipulation.noteStateMatrixToMidi(S, "ml/generated_chord_{}".format(i))
